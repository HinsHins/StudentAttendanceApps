...
class AttendanceDocMapper(var attendances : ArrayList<Attendance>, val attendanceViewModels: ArrayList<AttendanceViewModel>, ){
    ...
    private fun findStudent(students: ArrayList<Student>, studentId: String) : Student?{
